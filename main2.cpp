...
int main()
{
	...
	cout << "Comment :=>> --------------------------------------------------------------------------" << endl;
	cout << "Comment :=>> 				   TEST 11: Prova Bomba de Caramel" << endl;
	cout << "Comment :=>> " << endl;
	cout << "Comment :=>> --------------------------------------------------------------------------" << endl;
	cout << "Comment :=>> " << endl;
	partida.inicialitza("./data/partida_bomba_color.txt");
	posInicial.set(2, 1);
	posFinal.set(2, 2);
	partida.fesMoviment(posInicial, posFinal);
	partida.escriuTauler("./data/resultat_bomba_color.txt");
	correcte = comparaResultatPartida("./data/resultat_bomba_color.txt", "./data/resultat_bomba_color_esperat.txt");
	

	cout << "Comment :=>> --------------------------------------------------------------------------" << endl;
	cout << "Comment :=>> 				   TEST 12: Prova Envoltori" << endl;
	cout << "Comment :=>> " << endl;
	cout << "Comment :=>> --------------------------------------------------------------------------" << endl;
	cout << "Comment :=>> " << endl;
	
	partida.inicialitza("./data/partida_envoltori.txt");
	posInicial.set(9, 3);
	posFinal.set(8, 3);
	partida.fesMoviment(posInicial, posFinal);
	partida.escriuTauler("./data/resultat_envoltori.txt");
	correcte = comparaResultatPartida("./data/resultat_envoltori.txt", "./data/resultat_envoltori_esperat.txt");
	cin >> grade;
